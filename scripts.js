const CONFIG = {
  API_URL: 'https://script.google.com/macros/s/AKfycbzzYXc7w1OIr6Crtu5zoXHlQckR_oqjFW-wTBUx20lfTvBPvp_4jPuAKDDInauBwsELOQ/exec',
  VERSION: "V127-AI",
...
function decompressKeys(obj) {
  ...
  function switchBottomNavTab(section) {
    ...
    ['mainContent', 'heroSection', 'statsSection', 'settingsSection', 'gpsSection', 'aiSection', 'emptyState'].forEach(id => {
